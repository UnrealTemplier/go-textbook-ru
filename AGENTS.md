...
|---|:---:|---|
| 🌑 **Dark** | `dark` | **Тема по умолчанию.** Инженерная рабочая станция / вечерняя разработка. Глубокая тёмная палитра (`#0b0f19` / `#0f172a` / `#131d33`), сдержанные акценты indigo (`#6366f1`) и sky (`#38bdf8`). Минимальная зрительная нагрузка при работе с кодом. |
| 📄 **Paper** | `paper` | Эстетика классической инженерной книги, университетского справочника Bell Labs. Тёплый нейтральный фон (`#faf9f6` / `#ffffff`), спокойная контрастная типографика, минималистичные рамки, нулевая визуальная усталость при чтении. |
