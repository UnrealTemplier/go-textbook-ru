...
- [ ] **Эпиграф** (цитата Роба Пайка о собеседованиях/подготовке, на русском)
- [ ] **Mermaid-диаграмма 1:** Roadmap подготовки к Go-собеседованию (flowchart с этапами: Junior → Middle → Senior → Staff)
- [ ] **Mermaid-диаграмма 2:** Карта тем (mindmap-стиль через flowchart) — все 28 лекций с группировкой по блокам
- [ ] **Callout `[!IMPORTANT]`:** ключевые советы по стратегии подготовки
- [ ] **Новая секция:** «Что нового в Go 1.22–1.27» — краткая таблица актуальных фич, важных для собеседований
- [ ] **Callout `[!TIP]`:** список наиболее частых вопросов на Go-интервью в 2025–2026

### Критерии приёмки этапа 0:
- [ ] `python3 builder/build_all.py --all` → exit 0
- [ ] `python3 builder/audit_all.py` → 0 errors
- [ ] Файл содержит эпиграф в каноническом формате
- [ ] Файл содержит минимум 2 Mermaid-диаграммы с цветами согласно §2.5
- [ ] Коммит: `refactor(module22): этап 0 — введение, roadmap, таблица версий Go`
