...
- [x] **Полная пересборка:** `python3 builder/build_all.py --all` → exit 0, 0 errors
- [x] **Аудит:** `python3 builder/audit_all.py` → 0 OS errors, 0 Mermaid errors, 0 broken links
- [x] **Проверка эпиграфов:** все 28 файлов имеют эпиграфы в каноническом формате
- [x] **Проверка Mermaid:** все диаграммы имеют цветовую семантику (classDef / style)
- [x] **Подсчёт диаграмм:** `grep -r "mermaid" sources/22.\ */` → ≥ 56 диаграмм (фактически: 70 диаграмм)
- [x] **Проверка новых вопросов:** все 31 вопрос из MODULE22_NEW_QUESTIONS.md присутствуют в лекциях
- [x] **Проверка версий Go:** таблица версий Go 1.22–1.27 в файле 01 актуальна
- [x] **Обновление AGENTS.md:** раздел 22 → `✅ Завершен (100%)`, обновить счётчик Mermaid
- [x] **Финальный коммит:**
  ```bash
...
|---|---|---|
| Файлов | 28 | 28 |
| Диаграмм Mermaid | 0 | 70 (минимум 2 на файл) |
| Эпиграфов | 0 | 28 (канонические на русском) |
| Вопросов по Go 1.22–1.27 | 0 | 31 (Q01..Q31 интегрированы) |
| Callout-блоков `[!INTERVIEW]` | ~0 | ≥ 28 (во всех 28 файлах) |
